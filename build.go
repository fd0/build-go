...
var config = struct {
	...
	Name:      "dachs",               // name of the program executable and directory
	Namespace: "dachs",               // subdir of GOPATH, e.g. "github.com/foo/bar"
	Main:      "dachs/dachs",         // package name for the main package
	Tests:     []string{"dachs/..."}, // tests to run
}
